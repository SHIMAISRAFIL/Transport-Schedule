...
<div class="content">
				<div class="container_12">
					...
					<div class="grid_6 prefix_1">
						<a href="{{url('frontend/index2.html')}}" class="type"><img src="frontend/images/page1_img1.jpg" alt=""><span class="type_caption">Economy</span></a>
						<a href="{{url('frontend/index2.html')}}" class="type"><img src="frontend/images/page1_img2.jpg" alt=""><span class="type_caption">Standard</span></a>
						<a href="{{url('frontend/index2.html')}}" class="type"><img src="frontend/images/page1_img3.jpg" alt=""><span class="type_caption">Lux</span></a>
					</div>
					<div class="clear"></div>
				</div>
			</div>
