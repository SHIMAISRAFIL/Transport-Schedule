  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
        <div class="navbar-inner">
                ...
                <a class="brand" href="index.html"><span class="first"></span> <span class="second">Ayaat's Transports</span></a>
        </div>
    </div>
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">Terms and Conditions</h1>
                ...
                <ul class="breadcrumb">
            <li><a href="{{route('fronthome')}}">Home</a> <span class="divider">/</span></li>
...
<p>These Terms and Conditions are just a sample and are not legally binding. Real Terms of Services do not (usually) contain vegetables...</p>
                    ...
                    <footer>
                        ...
                        <p class="pull-right">A <a href="http://www.portnine.com/bootstrap-themes" target="_blank"></a> by <a href="http://www.portnine.com" target="_blank"></a></p>
